...
@section('main')
    ...
    <div style="display: flex; justify-content: center; align-items: center; padding-bottom: .5rem">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
            @foreach($airplanes as $airplane) <!--Change these-->
                <tr class="bg-gray-100">
                    <td style="text-align: center;">{{$airplane->id}}</td>
                    ...
                    <td style="text-align: center;">
                        <a href="{{route('airplanes.edit', $airplane)}}" style="color: white;background-color: #9ca3af; padding: 0.4rem">Edit</a>

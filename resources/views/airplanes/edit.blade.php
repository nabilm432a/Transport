    ...
    <div style="display: flex; justify-content: center; align-items: center; padding-bottom: .5rem;">
        <div class="text-white w-1/3" style="margin-top: 100px; border-radius: 8px; height: 90%; padding: 3rem;background-color: rgb(17, 24, 39);">
            ...
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                <form method="POST" action="{{route('airplanes.update', $airplane)}}">
                    @method('PUT')
                    @csrf
                    <div class="md:flex md:items-center mb-6 mt-2">
                        ...
                        <div class="md:w-2/3">
                            <input id="license_number" value="{{$airplane->license_number}}" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" name="license_number" type="text" readonly>
                        </div>
                    </div>
                    ...
                    <div class="md:flex md:items-center mb-6 mt-2">
                        ...
                        <div class="md:w-2/3">
                            <input id="capacity" value="{{$airplane->capacity}}" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" name="capacity" type="number">
                        </div>
                    </div>
                    ...
                    <div class="md:flex md:items-center mb-6 mt-2">
                        ...
                        <div class="md:w-2/3">
                            <input id="model" value="{{$airplane->model}}" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" name="model" type="text">
                        </div>
                    </div>

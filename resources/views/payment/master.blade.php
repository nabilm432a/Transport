...
@section('main')
    ...
    <div class="Vpayment">
        <div class="bkash_image">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/MasterCard_Logo.svg/200px-MasterCard_Logo.svg.png" class="paymentpic" alt="">
        </div>
        <form action="{{ route('processPayment') }}" method="post">
            @csrf
            <input type="hidden" name="travel_history1" value={{$travelHistory}} id="">
            <p style = "position:absolute; right:152px; top: 97px">Enter Your Master Card Number</p>

...
<div class="box">
    ...
    <div class="ticket">
        <span class="airline">Passenger Copy</span>
        <span class="airline airlineslip">Authority Copy</span>
        ...
        <div class="content">
            ...
            <div class="sub-content">
                ...
                <span class="passport">Passport<br><span>{{ $user->passport }}</span></span>
                <span class="nid">NID<br><span>{{ $user->nid }}</span></span>
                <span class="flight">Travel ID<br><span>{{ $travelHistory->id }}</span></span>
                <span class="gate">DATE<br><span>{{ \Carbon\Carbon::parse($travelHistory->created_at)->format('Y-m-d') }}</span></span>
                <span class="seat">Price<br><span>{{ $travelHistory->final_price }}</span></span>
                <span class="boardingtime">Contact Number<br><span>{{ $user->contact }}</span></span>

                <span class="flight flightslip">Travel ID<br><span>{{ $travelHistory->id }}</span></span>
                <span class="seat seatslip">Contact Number<br><span>{{ $user->contact }}</span></span>
